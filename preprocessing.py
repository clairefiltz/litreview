# copy paste code
# create function to run all steps together
# push file on git (check for branch)
...
print(preprocessing("/home/felix/code/clairefiltz/litreview/raw_data/subset_100.csv"))


# make preprocessing callable from terminal
